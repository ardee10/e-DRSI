					...
					<div class="row">
						...
						<div class="card mb-3">
							<div class="card-body">
								...
								<form class="row g-3 needs-validation" id="submit" method="post" action="<?= base_url('') ?>Home/submitFinding" enctype="multipart/form-data" novalidate>
									<div class="col-12">
									...
									<div class="col-6 align-center">
										<button class="btn btn-success w-100" type="button" value="Cancel" onclick="window.location='<?= base_url('Home/PageLeader') ?>'">Kembali</button>
									</div>
	...
	<script>
		...
		$(document).ready(function() {
			$('#gedung').change(function(event) {
				...
				$.ajax({
					type: "GET",
					url: `${base}home/data_cell/${gedungselect}`,
					dataType: "json",
			...
			$('#defect_stage').change(function(event) {
				...
				$.ajax({
					type: "GET",
					url: `${base}home/defectStage/${stage}`,
					dataType: "json",
					success: function(data) {
						// console.log(data);
						var a = "<option value=''>--- PILIH ---</option>";
			...
			$('#defectName').change(function(event) {
				...
				$.ajax({
					type: "GET",
					url: `${base}home/subdefectName/${defName}`,
					dataType: "json",
					success: function(data) {
						// console.log(data);
						var a = "<option value=''>--- PILIH ---</option>";
