...
-- Records of tbl_area
-- ----------------------------
INSERT INTO `tbl_area` VALUES (1, 'ASSEMBLY');
INSERT INTO `tbl_area` VALUES (2, 'CUTTING');
INSERT INTO `tbl_area` VALUES (3, 'KANDIDAT PIMPINAN');
INSERT INTO `tbl_area` VALUES (4, 'LOGISTIC');
INSERT INTO `tbl_area` VALUES (5, 'PREPARATION');
INSERT INTO `tbl_area` VALUES (6, 'SEWING');
...
-- ----------------------------
INSERT INTO `tbl_finding` VALUES (33, '2025-01-31', 'F4', 'F4-12', 'GY6577', 'ACTIVLEX BOA', 'CT', 'CTEMB', 'CT21', 'GY6577.PNG', '1', 'CUTTING', 'INPUT COMP.TREATMENT\r\n', 'NANANG SRI WIDODO\r\nRIAN AGUSTIAN', 2, 'COMP.STITCH', '149710', 1, 'MOHON SEGERA DIPERBAIKI. THANKS');
INSERT INTO `tbl_finding` VALUES (34, '2025-01-31', 'F2', 'F2-1', 'JP6528', 'ADIZERO BK', 'FS', 'FS', 'FS56', 'JP6528.PNG', '1', 'STITCHING \r\n', 'INPUT COMP.TREATMENT\r\n', 'HANAFI\r\nYUDHIKA\r\nAZIZ', 2, 'PREPARATION', '149710', 1, 'TOLONG DI FOLLOW UP');
INSERT INTO `tbl_finding` VALUES (35, '2025-02-03', 'F3', 'F3-13', 'ID9572', 'ADVANTAGE BASE', 'CT', 'CTSUB', 'CT32', 'ID9572.PNG', '3', 'CUTTING', 'CUTTER\r\n', 'ADAM', 2, 'COMP.STITCH', '149710', 1, 'TOLONG FOLLOW UP');
INSERT INTO `tbl_finding` VALUES (37, '2025-02-05', 'F4', 'F4-12', 'GW9284', 'ADVANTAGE BASE', 'CT', 'CTEMB', 'CT21', 'GW9284.PNG', '2', 'BOTTOM B1/B2\r\n', 'SEWING\r\n', 'YUDI', 12, 'COMP.STITCH', '149710', 1, 'TOLONG DI TINDAK LANJUTI');
INSERT INTO `tbl_finding` VALUES (38, '2025-02-05', 'F2', 'F2-11', 'IF8007', 'ADVANTAGE BASE', 'FS', 'FS', 'FS58', 'IF8007.PNG', '1', 'CUTTING', 'INPUT COMP.TREATMENT\r\n', 'YUDI\r\nARIF\r\nAZIZ', 2, 'COMP.STITCH', '149710', 1, 'Lebih detail dalam pengecekan');
INSERT INTO `tbl_finding` VALUES (39, '2025-02-01', 'F1', 'F1-16', 'ID5889', 'ADVANTAGE BASE', 'OS', 'OS', 'OS47', 'ID5889.PNG', '2', 'CUTTING', 'ASSY INPUT OUTSOLE / MARKING\r\n', 'AZIZ\r\nADIB', 2, 'PREPARATION', '148755', 1, 'TEST');
INSERT INTO `tbl_finding` VALUES (40, '2025-01-01', 'F4', 'F4-12', 'JP5220', 'ALPHAEDGE +', 'SLU', 'SLU', 'SLU4', 'JP5220.PNG', '2', 'IN-HOUSE / SUBCONTRACTORS', 'SEWING\r\n', '11', 2, 'TQC', '148755', 1, 'TOLONG DI FOLLOW UP');
INSERT INTO `tbl_finding` VALUES (41, '2025-02-13', 'F4', 'F4-14', 'ART001', 'ADVANTAGE', 'SLU', 'SLU', 'SLU3', 'ART001.PNG', '1', 'CUTTING', 'CUTTER\r\n', 'YUDI\r\nARIF\r\nDHIKA\r\nJUHAEDI', 1, 'PREPARATION', '149710', 1, 'TOLONG DI FOLLOW UP');
INSERT INTO `tbl_finding` VALUES (42, '2025-02-13', 'F4', 'F4-15', 'JR781', 'GRAND COURT 00S', 'CC', 'CC', 'CC14', 'JR781.PNG', '14', 'CUTTING', 'CUTTER\r\n', 'QIC INCOMING', 3, 'CUTTING', '239900', 1, '');
INSERT INTO `tbl_finding` VALUES (43, '2025-02-14', 'F1', 'F1-18', 'JS0696', 'BREAKNET GOAL EL C', 'FS', 'FS', 'FS59', 'JS0696.PNG', '10', 'BOTTOM B1/B2\r\n', 'ASSY INPUT OUTSOLE / MARKING\r\n', '1. HANAFI\r\n2. YUDHIKA\r\n3.AZIZ', 3, 'COMP.STITCH', '239900', 1, 'TOLONG DI FOLLOW UP');
INSERT INTO `tbl_finding` VALUES (44, '2025-02-14', 'F3', 'F3-18', 'JS0697', 'BREAKNET GOAL EL C', 'FS', 'FS', 'FS53', 'JS0697.PNG', '2', 'CUTTING', 'SEWING\r\n', 'ADAM\r\nAPRIL\r\nALEN', 3, 'COMP.STITCH', '239900', 1, '');
INSERT INTO `tbl_finding` VALUES (45, '2025-02-14', 'F1', 'F1-17', 'JS0595', 'CAMPUS 2', 'FS', 'FS', 'FS54', 'JS0595.PNG', '5', 'CUTTING', 'CUTTER\r\n', 'NANANG\r\nYUDI', 2, 'TQC', '239900', 1, 'TOLONG BAGIAN TQC diperbaiki. Terimakasih');
...
-- ----------------------------
-- Table structure for tbl_leader
-- ----------------------------
DROP TABLE IF EXISTS `tbl_leader`;
CREATE TABLE `tbl_leader`  (
  `id_leader` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `nama_leader` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  ...
  `area` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `password_real` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id_leader`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of tbl_leader
-- ----------------------------
INSERT INTO `tbl_leader` VALUES ('67ad6b6a1d961', 'KIFFIRUL AZIZ', '145879', 'F1', 'fe91f76f946e457464eff551b3d7f3db', 'F1-1', '2025-02-13 10:54:47', 'ASSEMBLY', '145879');
INSERT INTO `tbl_leader` VALUES ('67ad6e9b030f1', 'Muhammad Ardiyansah', '148755', 'F2', '79fe1b8b20f391b8d420728c96459089', 'F2-3', '2025-01-23 16:17:08', 'KANDIDAT PIMPINAN', '148755');
INSERT INTO `tbl_leader` VALUES ('67ad74c00b96b', 'Muhammad Khoirul Khanafi', '149922', 'F2', 'b083b6056f31f0c60033a4b471a57ec2', 'F2-3', '2025-02-13 11:44:27', 'PREPARATION', '149922');
INSERT INTO `tbl_leader` VALUES ('67adb7e782c23', 'Nanang Sri Widodo', '149710', 'F4', '2d951675ed237b36230a849df7f10334', 'F4-12', '2025-02-13 16:15:14', 'CUTTING', '149710');
INSERT INTO `tbl_leader` VALUES ('67adbd60a5669', 'Fitri Ulan Diana', '239900', 'F3', '5e0d82cbde7e8dc409c559dfed597a7d', 'F3-5', '2025-02-13 16:36:37', 'CUTTING', '239900');
INSERT INTO `tbl_leader` VALUES ('67b0a1c0c23a0', 'ELLA', '159874', 'F2', 'fd485f66ad03b04bd3e6a47ba4cc4067', 'F2-14', '2025-02-15 21:32:16', 'SEWING', '159874');
...
-- Records of tbl_user
-- ----------------------------
INSERT INTO `tbl_user` VALUES (1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'ADAM RAHMAT HIDAYAT', 1);
